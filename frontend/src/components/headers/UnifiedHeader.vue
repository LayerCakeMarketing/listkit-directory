<template>
  <nav class="fixed z-50 top-0 left-0 w-full bg-white border-b border-gray-100">
    ...
    <div class="mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between h-16">
        <div class="flex">
          ...
          <!-- Navigation Links - Show for authenticated users -->
          <div v-if="isAuthenticated && user" class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
          ...
          <div v-else class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
            <NavLink 
              :to="{ name: 'Places' }" 
              :active="isActive({ name: 'Places' })"
            >
              Places
            </NavLink>
            <NavLink 
              :to="{ name: 'PublicLists' }" 
              :active="isActive({ name: 'PublicLists' })"
            >
              Browse Lists
            </NavLink>
          </div>
...
const navigation = computed(() => {
  ...
  if (!userRole || !user.value) return { main: [], admin: [], user: [] }
