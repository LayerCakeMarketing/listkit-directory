        ...
        <div class="mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 mb-6">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex gap-3">
                        <router-link
                            to="/admin/marketing-pages/local"
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <router-link
                        to="/admin/marketing-pages/places"
                        class="block p-4 bg-gray-50 hover:bg-gray-100 rounded-lg transition-colors"
                    >
                        <div class="flex items-center justify-between">
                            <div>
                                <h4 class="font-medium text-gray-900">Places Page</h4>
                                <p class="text-sm text-gray-500">Marketing content for /places</p>
                            </div>
                    ...
                    <router-link
                        to="/admin/marketing-pages/lists"
                        class="block p-4 bg-gray-50 hover:bg-gray-100 rounded-lg transition-colors"
                    >
                        <div class="flex items-center justify-between">
                            <div>
                                <h4 class="font-medium text-gray-900">Lists Page</h4>
                                <p class="text-sm text-gray-500">Marketing content for /lists</p>
                            </div>
                            <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                            </svg>
                    ...
                    <router-link
                        to="/admin/marketing-pages/register"
                        class="block p-4 bg-gray-50 hover:bg-gray-100 rounded-lg transition-colors"
                    >
                        <div class="flex items-center justify-between">
                            <div>
                                <h4 class="font-medium text-gray-900">Register Page</h4>
                                <p class="text-sm text-gray-500">Marketing content for /register</p>
                            </div>
                            <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                            </svg>
